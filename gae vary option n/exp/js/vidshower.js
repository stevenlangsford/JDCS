...
//populate lineup
var suspects = shuffle(["M.hs.yg.md.br.bn.ngl.sd.jpg","m.wt.yg.st.bk.bn.ngl.sh8.jpg","M.wt.yg.st.br.bn.ngl.sh8.jpg","M.hs.yg.st.bk.bn.ngl.sd - Copy.jpg","M.wt.yg.st.br.bn.ngl.sh16.jpg","m.wt.yg.st.br.bu.ngl.sh16.jpg","M.wt.yg.st.br.bn.ngl.sh2.jpg","M.wt.yg.st.br.bu.ngl.sh7.jpg","m.wt.ma.st.br.bn.ngl.sh2.jpg", "M.wt.yg.st.br.bn.ngl.sh6.jpg","M.wt.yg.st.br.hz.ngl.sh3.jpg"]);
var suscounter = 0;
...
for(var i=0;i<condition;i++){
    drawstring+="<div class='canvasholder' style='float:left;width:"+(canvaswidth)+"px'><canvas id='canvas"+i+"' width='"+canvaswidth+"' height='"+canvasheight+"'></canvas><button style='border-radius:25px;' onclick='lineupresponse(\""+i+"\")'>&#8593;</button></div>"
}
